...
{
    /// <inheritdoc />
    public partial class ThrobDB : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DriveSessions", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "ExamRequestModels",
                columns: table => new
                {
                    ExamRequestId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NumberOfQuestions = table.Column<int>(type: "int", nullable: false),
                    IncludeMCQ = table.Column<bool>(type: "bit", nullable: false),
                    IncludeTrueFalse = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExamRequestModels", x => x.ExamRequestId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DriveSessionId = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "ExamRequestQuestions",
                columns: table => new
                {
                    ExamRequestsExamRequestId = table.Column<int>(type: "int", nullable: false),
                    QuestionsQuestionId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExamRequestQuestions", x => new { x.ExamRequestsExamRequestId, x.QuestionsQuestionId });
                    table.ForeignKey(
                        name: "FK_ExamRequestQuestions_ExamRequestModels_ExamRequestsExamRequestId",
                        column: x => x.ExamRequestsExamRequestId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VConnectLink = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
